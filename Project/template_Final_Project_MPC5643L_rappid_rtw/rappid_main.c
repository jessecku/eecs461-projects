...
{
  /* Initialize model */
  template_Final_Project_MPC5643L_initialize(1);
}
...
void SYSTEM_TASK(void)
{
   ...
   */
  template_Final_Project_MPC5643L_SetEventsForThisBaseStep(eventFlags);

  /* Set model inputs associated with base rate here */
  template_Final_Project_MPC5643L_step(0);

  /* Get model outputs here */
  if (eventFlags[1]) {
    /* Set model inputs associated with subrates here */
    template_Final_Project_MPC5643L_step(1);
