...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real32_T   *delta  = (const real32_T*) ssGetInputPortSignal(S,1);
    const real32_T   *psi  = (const real32_T*) ssGetInputPortSignal(S,2);
    const real32_T   *L1  = (const real32_T*) ssGetInputPortSignal(S,3);
    const real32_T   *L2  = (const real32_T*) ssGetInputPortSignal(S,4);
    real32_T        *xdot  = (real32_T *)ssGetOutputPortRealSignal(S,0);
    real32_T        *ydot  = (real32_T *)ssGetOutputPortRealSignal(S,1);
    real32_T        *psidot  = (real32_T *)ssGetOutputPortRealSignal(S,2);

    vmod_Outputs_wrapper(u, delta, psi, L1, L2, xdot, ydot, psidot);
}
