...
MODEL           = two_virtual_wheel_autocode
MODULES         = FlexPWM_564xL_library.c eTimer_564xL_library.c flexpwm_init.c gpio_564xl_library.c intc_init.c intc_sw_vectable.c rappid_main.c rappid_utils.c rtGetInf.c rtGetNaN.c rt_nonfinite.c siu_init.c sys_init.c sysclk_init.c 
MAKEFILE        = two_virtual_wheel_autocode.mk
...
MEM_ALLOC       = RT_STATIC
COMPUTER        = PCWIN
BUILDARGS       =  GENERATE_REPORT=0 INCLUDE_MDL_TERMINATE_FCN=1 COMBINE_OUTPUT_UPDATE_FCNS=1 MULTI_INSTANCE_CODE=0 INTEGER_CODE=0 PORTABLE_WORDSIZES=0 GENERATE_ERT_S_FUNCTION=0
MULTITASKING    = 1
MAT_FILE        = 0
GENERATE_ASAP2 	= 0
EXT_MODE             = 0
...
MODELLIB                  = two_virtual_wheel_autocodelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-IC:\Users\chriswer\Downloads\chris\two_virtual_wheel_autocode_rappid_rtw \
	-IC:\Users\chriswer\Downloads\chris \
