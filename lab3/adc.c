...
#define ONE_SHOT  0x0 //Fill in value associated with one-shot mode
#define SCAN_MODE 0x1 //Fill in value associated with scan mode
...
void initADC0_oneshot(char numChannels, char channelArray[])
{
  ...
  ADC0.CTR0.B.INPCMP = 0b1;
  ADC0.CTR0.B.INSAMP = 0x8;
